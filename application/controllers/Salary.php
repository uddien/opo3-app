...
class Salary extends CI_Controller {
    ...
    public function insert()
    {
        ...
        $staff=$this->input->post('txtstaff');
        ...
        { 
            if($total[$i]>0)
            {
                $data=$this->Salary_model->insert_salary(array('id'=> $id[$i],
                    'gender' => $gender,
        ...
        if(isset($data)){
            ...
            foreach($data as $d)
            {
                ...
                <td><input type="hidden" name="txtid[]" value="'.$d["id"].'">
                    <input type="text" name="txtgender[]" class="form-control expenses">
                </td>
                <td><input type="text" name="txtdepartment[]" class="form-control expenses"></td>
                <td><input type="text" id="total" name="txtstaff[]" class="form-control"></td>
                <td><input type="text" id="total" name="txtaddress[]" class="form-control"></td>
                </tr>';
            }
            print '</tbody>
            </table>
